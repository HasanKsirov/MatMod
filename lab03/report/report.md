...
subtitle: "Модель боевых действий - вариант 22"
...
В начальный момент времени страна $X$ имеет армию численностью 24000 человек, а в распоряжении страны $Y$ армия численностью в 54000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.4x(t) - 0.64y(t) + sin(t+5)+1
	\\   
	\frac{dy}{dt}= -0.77x(t) - 0.3y(t) + cos(t+5)+1
 \end{cases}
$$

```
x0 = 24000;//численность первой армии
y0 = 54000;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.4;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.64;//эффективность боевых действий армии у
c = 0.77;//эффективность боевых действий армии х
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.35x(t) - 0.67y(t) + sin(2t)+2
	\\   
	\frac{dy}{dt}= -0.77x(t)y(t) - 0.45y(t) + cos(t)+1
 \end{cases}
$$
...
c = 0.77;//эффективность боевых действий армии х
h = 0.45;//константа, характеризующая степень влияния различных факторов на потери армии у
tmax = 1;//предельный момент времени
dt = 0.05;//шаг изменения времени
t = [t0:dt:tmax];
function p=P(t)//возможность подхода подкрепления к армии х
