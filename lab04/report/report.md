...
subtitle: "Модель гармонических колебаний - вариант 22"
...
силы $\ddot{x}+1.5\dot{x}+3x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+0.6\dot{x}+x=\cos{1.5t}$

На итнтервале $t \in [ 0;62 ]$, шаг 0.05, $x_0=0.8, y_0=-1$
